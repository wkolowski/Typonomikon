...
Lemma app_inv1 :
  forall (A : Type) (n m : nat) (l : RVec A n) (l1 l2 : RVec A m),
    l +++ l1 = l +++ l2 -> l1 = l2.
(* begin hide *)
Proof.
  induction l; cbn; intros.
...
Lemma is_vnil :
  forall (A : Type) (n : nat) (l : RVec A n),
...
(* begin hide *)
Fixpoint snoc {A : Type} {n : nat} (x : A) (l : RVec A n) : RVec A (S n) :=
match l with
    | vnil => vcons x vnil
    | vcons h t => vcons h (snoc x t)
end.

Fixpoint rev {A : Type} {n : nat} (l : RVec A n) : RVec A n :=
match l with
    | vnil => vnil
...
Lemma snoc_app :
  forall (A : Type) (x : A) (n m : nat) (l1 : RVec A n) (l2 : RVec A m),
...
Lemma snoc_rev :
  forall (A : Type) (n : nat) (x : A) (l : RVec A n),
...
Lemma rev_rev :
  forall (A : Type) (n : nat) (l : RVec A n), rev (rev l) = l.
(* begin hide *)
Proof.
  induction l; cbn.
    trivial.
...
(* begin hide *)
Inductive elem {A : Type} : A -> forall n : nat, RVec A n -> Prop :=
    | elem_head : forall (n : nat) (x : A) (l : RVec A n),
        elem x (vcons x l)
...
Lemma elem_inv_head :
  forall (A : Type) (n : nat) (x h : A) (t : RVec A n),
...
Lemma elem_snoc' :
  forall (A : Type) (n : nat) (x y : A) (l : RVec A n),
...
Lemma elem_split :
  forall (A : Type) (n : nat) (x : A) (l : RVec A n),
    elem x l -> exists (m1 m2 : nat) (l1 : RVec A m1) (l2 : RVec A m2),
      eq_dep l (l1 ++ x :: l2).
(* begin hide *)
Proof.
...
(* begin hide *)
Fixpoint map {A B : Type} {n : nat} (f : A -> B) (la : RVec A n) : RVec B n :=
match la with
    | [] => []
    | h :: t => f h :: map f t
end.
...
Lemma map_id : forall (A : Type) (n : nat) (l : RVec A n),
  map id l = l.
(* begin hide *)
Proof.
...
Lemma map_comp :
  forall (A B C : Type) (n : nat) (f : A -> B) (g : B -> C)
    (l : RVec A n), map g (map f l) = map (fun x : A => g (f x)) l.
(* begin hide *)
Proof.
...
Lemma map_length :
  forall (A B : Type) (n : nat) (f : A -> B) (l : RVec A n),
    len (map f l) = len l.
(* begin hide *)
Proof.
  induction l as [| n h t]; cbn.
...
Lemma map_app :
  forall (A B : Type) (n m : nat) (f : A -> B) (l1 : RVec A n) (l2 : RVec A m),
...
Lemma elem_map :
  forall (A B : Type) (n : nat) (f : A -> B) (l : RVec A n) (x : A),
...
Lemma elem_map_conv :
  forall (A B : Type) (n : nat) (f : A -> B) (l : RVec A n) (y : B),
...
Lemma map_snoc :
  forall (A B : Type) (n : nat) (f : A -> B) (x : A) (l : RVec A n),
...
Lemma map_ext_elem :
  forall (A B : Type) (n : nat) (f g : A -> B) (l : RVec A n),
...
(* begin hide *)
Fixpoint join {A : Type} (n m : nat) (lla : RVec (RVec A n) m)
  : RVec A (m * n) :=
match lla with
    | [] => []
    | h :: t => h ++ join t
...
Lemma join_app :
  forall (A : Type) (n n' m m' : nat) (l1 : RVec (RVec A n) m)
  (l2 : RVec (RVec A n) m'),
...
Lemma join_map :
  forall (A B : Type) (n m : nat) (f : A -> B) (l : RVec (RVec A n) m),
...
(* begin hide *)
Fixpoint repeat {A : Type} (n : nat) (x : A) : RVec A n :=
match n with
    | 0 => []
    | S n' => x :: repeat n' x
end.
...
(* begin hide *)
Fixpoint nth {A : Type} {n : nat} (m : nat) (l : RVec A n) : option A :=
match m, l with
    | _, [] => None
    | 0, h :: t => Some h
    | S n', h :: t => nth n' t
...
Lemma nth_len :
  forall (A : Type) (m n : nat) (l : RVec A n),
...
Lemma nth_app1 :
  forall (A : Type) (m n1 n2 : nat) (l1 : RVec A n1) (l2 : RVec A n2),
...
Lemma nth_split :
  forall (A : Type) (m n : nat) (l : RVec A n) (x : A),
    nth m l = Some x -> exists (n1 n2 : nat) (l1 : RVec A n1) (l2 : RVec A n2),
...
Lemma map_nth :
    forall (A B : Type) (m n : nat) (f : A -> B) (l : RVec A n) (x : A),
...
(* begin hide *)
Definition head {A : Type} {n : nat} (l : RVec A (S n)) : A :=
match l with
    | h :: _ => h
end.

Fixpoint last {A : Type} {n : nat} (l : RVec A (S n)) {struct l} : A.
Proof.
...
(*Fixpoint head {A : Type} {n : nat} (l : RVec A n) : option A :=
match l with
    | [] => None
    | h :: _ => Some h
end.*)

(*Fixpoint last {A : Type} {n : nat} (l : RVec A n) : option A :=
match l with
    | [] => None
...
Lemma head_nth:
  forall (A : Type) (n : nat) (l : RVec A (S n)),
    Some (head l) = nth 0 l.
(* begin hide *)
Proof.
...
Lemma last_nth : forall (A : Type) (n : nat) (l : RVec A (S n)),
  Some (last l) = nth n l.
(* begin hide *)
Proof.
...
Definition tail {A : Type} {n : nat} (l : RVec A (S n)) : RVec A n :=
match l with
    | _ :: t => t
end.

Fixpoint init {A : Type} {n : nat} (l : RVec A (S n)) {struct l} : RVec A n.
Proof.
...
Fixpoint take {A : Type} {n : nat} (m : nat) (l : RVec A n) : RVec A (min m n).
Proof.
  destruct m as [| m']; cbn.
    exact vnil.
...
Fixpoint drop {A : Type} {n : nat} (m : nat) (l : RVec A n) : RVec A (n - m).
Proof.
  destruct m as [| m']; cbn.
...
Lemma take_cons :
  forall (A : Type) (n m : nat) (h : A) (t : RVec A n),
...
Lemma take_length' :
  forall (A : Type) (n m : nat) (l : RVec A n),
...
Lemma take_map :
  forall (A B : Type) (f : A -> B) (m n : nat) (l : RVec A n),
...
Lemma take_take :
  forall (A : Type) (m m' n : nat) (l : RVec A n),
...
Lemma take_drop :
  forall (A : Type) (a b n : nat) (l : RVec A n),
